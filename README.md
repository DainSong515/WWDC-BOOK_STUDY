...
- 공부방법 (챕터와 영상이 긴 경우에는 끊어서 발표 진행)
   - 📽️ WWDC: 스터디를 하기 1주 전에는 **발표자가 어떤 주제를 어느 정도까지 끊어서 볼 것 인지** Discussion에 작성하기 
   - 📕 책: 스터디를 하기 1주 전에는 **발표자가 Chapter를 어느 정도로 나눠서 할 것인지** Discussion에 작성하기 (Ch.5까지 하고 종료)
   - 🙈 ARMUGUNA: 스터디하기 하루 전에 각자 공부한 내용 아무거나 올리고 다같이 이야기, 안 올리면 벌금 3000원  
...
| 35주차 |    아무거나 발표 time   |    홍동현, 송다인, 연정민    |      2023.06.29 (목)     |
| 36주차 |    [WWDC 2023: Discover Observation in SwiftUI](https://developer.apple.com/videos/play/wwdc2023/10149/)  |    송다인    |      2023.07.06 (목)     |
| 37주차 |    아무거나 발표 time   |    홍동현, 송다인, 연정민    |      2023.07.12 (수)     |
